...
from MyHome.models import FilePublic, FilePrivate, FilePublicTrashTb, FilePrivateTrashTb, FileDefaultPathTb
from MyHome.db.database_enum import File as modeEnum
from MyHome.db.database_enum import FileDataType as dataType
from MyHome.db.file_database_connection import DBConnection
import uuid
