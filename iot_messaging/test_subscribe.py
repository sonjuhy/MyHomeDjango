...
from iot_messaging.MQTT.subscribe import Subscribe
...
class TestSubscribe:
    ...
    @patch('iot_messaging.MQTT.subscribe.producer.send')
    @patch('iot_messaging.MQTT.subscribe.publisher.pub')
    @patch('iot_messaging.MQTT.subscribe.db_conn.main')
