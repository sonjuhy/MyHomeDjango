...
from iot_messaging.kafka.kafka_producer import get_kafka_data
from iot_messaging.kafka.kafka_consumer import listen, run, kafka_cloud_producer
from iot_messaging.kafka.kafka_enum import KafkaEnum as kafkaEnum
from iot_messaging.kafka.light_reserve import job
from core.models import Reserve, RoomLight
...
class TestKafkaConsumer:
    @patch('iot_messaging.kafka.kafka_consumer.KafkaConsumer')
    @patch('iot_messaging.kafka.kafka_consumer.publisher.pub')
    ...
    @patch('iot_messaging.kafka.kafka_consumer.KafkaConsumer')
    @patch('file_manager.file.file_move.file_move')
    ...
    @patch('iot_messaging.kafka.kafka_consumer.KafkaConsumer')
    @patch('file_manager.file.file_move.file_delete')
    ...
    @patch('iot_messaging.kafka.kafka_consumer.KafkaConsumer')
    @patch('task_scheduler.schedule.main_scheduler.MainScheduler')
    @patch('iot_messaging.kafka.light_reserve.job.job_refresh')
    ...
    @patch('iot_messaging.kafka.kafka_consumer.KafkaConsumer')
    @patch('iot_messaging.kafka.kafka_consumer.set_reserve_result')
    ...
    @patch('iot_messaging.kafka.kafka_consumer.KafkaProducer')
...
class TestLightReserveJob:
    @patch('iot_messaging.kafka.light_reserve.job.producer.send')
    ...
    @patch('iot_messaging.kafka.light_reserve.job.producer.send')
    @patch('iot_messaging.kafka.light_reserve.job.pub')
