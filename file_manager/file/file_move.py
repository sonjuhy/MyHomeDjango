...
from core.db.database_enum import File as modeFileEnum
import file_manager.db.file_database_connection as file_database
...
def file_delete(uuid: str, file: str) -> int:
    ...
    try:
        ...
        logger.error('file_delete error : {}'.format(e))
