...
import os
from file_manager.file.file_move import get_default_public_path, get_default_private_path, file_move

class TestFileMove:
    @patch('file_manager.db.file_database_connection.DBConnection')
    ...
    @patch('file_manager.file.file_move.producer.send')
    @patch('file_manager.file.file_move.get_default_public_path')
    ...
    @patch('os.path.exists')
    @patch('file_manager.file.file_move.producer.send')
    @patch('file_manager.file.file_move.get_default_private_path')
